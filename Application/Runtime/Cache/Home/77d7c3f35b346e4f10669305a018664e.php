    ...
    <style>
        * {
        ...
        body {
            ...
            font-size: 0.825em;
            color: #eee;
            background: url("/book/Public/img/bg.png") repeat-x #222222;
...
<body>
    <div id="carbonForm">
        ...
        <form action="<?php echo U('/alter');?>" method="post" id="signupForm">
            <div class="fieldContainer">
                ...
                <div class="formRow">
                    <div class="label">
                        <label for="name">重复输入:</label>
                    </div>
                    <div class="field">
                        <input type="password" name="twopwd" />
                    </div>
                </div>
                <div class="formRow">
                </div>
                <div class="formRow">
                    ...
                    <img src="<?php echo U('Base/createVerify');?>" title="点击刷新" onClick="changeVerify()" />
                </div>
            </div>
