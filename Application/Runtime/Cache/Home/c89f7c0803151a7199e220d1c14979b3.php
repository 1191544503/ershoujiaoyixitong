    ...
    <style>
        * {
        ...
        body {
            ...
            font-size: 0.825em;
            color: #eee;
            background: url("/huabanshe/Public/img/pic03.png") repeat-x #222222;
        ...
        .field input {
            ...
            font-size: 22px;
            padding: 4px 5px;
            background: url("/huabanshe/Public/img/box_bg.png") repeat-x scroll left top #FFFFFF;
            outline: none;
        ...
        #submit {
            ...
            width: 110px;
            background: url("/huabanshe/Public/img/submit.png") no-repeat center center #d0ecfd;
        ...
        #submit.active {
            ...
            background-image: url("/huabanshe/Public/img/preloader.gif");
        }
...
<body>
    <div id="carbonForm">
        ...
        <form action="<?php echo U('/login');?>" method="post" id="signupForm">
            <div class="fieldContainer">
                <div class="formRow">
                    ...
                    <div class="field">
                        <input type="text" name="id" id="name" value="<?php echo ($data[user]); ?>" />
                    </div>
                </div>
                <div class="formRow">
                </div>
